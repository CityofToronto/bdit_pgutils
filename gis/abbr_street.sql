-- FUNCTION: gis.abbr_street2(text)
...
ALTER FUNCTION gis.abbr_street2(text)
    OWNER TO bdit_humans;

COMMENT ON FUNCTION gis.abbr_street2(text)
    IS 'Text manipulation to abbreviate suffixes and other information a street field. 
Returns a string ';
